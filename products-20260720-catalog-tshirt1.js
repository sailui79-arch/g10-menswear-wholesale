const G10_CATEGORIES = [
  ...
  { id: "winter", label: "အနွေးပါး", english: "Light Outerwear" },
...
window.G10_PRODUCTS = [
  ...
  ...[
    ...
    id: `G10-O${String(index + 19).padStart(3, "0")}`,
    name: "အပေါ်ထပ်အင်္ကျီ",
    category: "outerwear",
    categoryLabel: "အပေါ်ထပ်အင်္ကျီ",
    categoryEnglish: "Jackets",
  ...
  ...[
    ...
    id: `G10-B${String(index + 51).padStart(3, "0")}`,
    name: "ဘီတို",
    category: "sweater",
    categoryLabel: "ဘီတို",
    categoryEnglish: "Shorts",
...
window.G10_PRODUCTS.push(
  ...Array.from({ length: 13 }, (_, index) => `G10-FC${String(index + 1).padStart(3, "0")}`)
    .map((photoId) => ({
      ...
      categoryLabel: "ဂျင်းဘောင်းဘီ",
      categoryEnglish: "Jeans",
      image: `./products/2026-07-20-jeans-fc/${photoId}.webp`,
      sizes: ["M", "L", "XL", "2XL", "3XL"],
      minQty: 1
    }))
);
...
// T-shirts G10-T001 through G10-T022 and G10-T056 through G10-T106 are
// permanently off shelf and their originals were deleted.
window.G10_PRODUCTS = window.G10_PRODUCTS.filter((product) => {
  ...
  const isDeletedRange =
    (productNumber >= 1 && productNumber <= 22) ||
